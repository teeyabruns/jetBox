<%@ Page Title="Sign Up 2" Language="C#" MasterPageFile="~/JetBoxHome.Master" AutoEventWireup="true" CodeBehind="SignUp2.aspx.cs" Inherits="JetBox.WebForm10" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="MainContentArea" runat="server">
    ...
    <div id ="fields" style ="background-color: #c9f1fd; text-align: center; border-radius: 15px">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:JetBoxConnectionString9 %>" SelectCommand="SELECT [User_FName], [User_LName], [User_Address], [User_City], [User_State], [User_Zip], [User_Email], [User_Password], [User_PaymentInfo] FROM [User]"></asp:SqlDataSource>
